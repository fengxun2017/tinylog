...
class DataBuffer {
   public:
    ...
    size_t get_buffer_size(void) { return _BUFFER_SIZE;}

    size_t get_data_size(void) { return _cur_size; }

    const char *get_buffer(void) { return _buffer; }
/**
 ...
 */
   ...
   private:
    ...
    static const size_t _BUFFER_SIZE = 1 * 1024 * 1024;
...
* @note The elements stored in the queue are pointer data pointing to the DataBuffer type.
*/
class BufferQueue {
   public:
    /**
