...
void producer_thread1(logging::BufferQueue &input_queue,
                      logging::BufferQueue &output_queue) {
...
void producer_thread2(logging::BufferQueue &input_queue,
                      logging::BufferQueue &output_queue) {
...
void consumer_thread(logging::BufferQueue &input_queue,
                     logging::BufferQueue &output_queue) {
...
int main(void) {
    ...
    std::thread p1(producer_thread1, std::ref(input_queue),
                   std::ref(output_queue));
    std::thread p2(producer_thread2, std::ref(input_queue),
                   std::ref(output_queue));
    std::thread c1(consumer_thread, std::ref(input_queue),
                   std::ref(output_queue));
